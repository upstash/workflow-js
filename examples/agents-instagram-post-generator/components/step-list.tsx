...
export type StepItemProps = React.ComponentPropsWithoutRef<'div'>
...
export type StepTitleProps = React.ComponentPropsWithoutRef<'h3'>
...
export type StepDescProps = React.ComponentPropsWithoutRef<'h3'>
...
export type StepContentProps = React.ComponentPropsWithoutRef<'div'>
