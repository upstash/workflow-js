  ...
  return (
    <>
      ...
      <div className="mt-3 font-semibold">
        Result:{' '}
        <code className="rounded-md bg-zinc-200/40 px-1 py-1">
      ...
      <div className="flex items-baseline gap-2">
        <span>
          <Tooltip
            title={
              <>
                <b>Total Duration</b> measures the full process time, from
                sending the initial request to receiving the generated image
                from the API. This time is typically longer for Upstash Workflow
      ...
      <div className="flex items-baseline gap-2">
        <span>
          <Tooltip
            title={
              <>
                <b>Vercel Function Duration</b> is the total active time of a
                Vercel function, including processing and waiting. A standard
                Vercel function stays active while waiting for the image
                generation. You're billed for the entire time, including
                waiting. With Upstash Workflow, a function finishes quickly
                after sending the request to Upstash and you're not billed for
                idle waiting time.
              </>
            }
          >
          ...
          <Tooltip
            title={
              <>
                ...
                .
                <a
                  href="https://upstash.com/docs/qstash/workflow/pricing"
                  target="_blank"
                >
                  Each workflow run in this example makes 4 QStash requests
                </a>
                . Image generation cost is not included in either method.
              </>
            }
          >
